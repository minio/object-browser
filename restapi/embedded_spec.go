...
func init() {
  ...
  "paths": {
    ...
    "/buckets/{name}/health": {
      "get": {
        "description": "Returns the health status of buckets including region, URL, and status.",
        "tags": [
          "UserAPI"
        ],
        "summary": "Get bucket health status",
        "operationId": "getBucketHealth",
        "parameters": [
          {
            "type": "string",
            "name": "name",
        ...
        "responses": {
          "200": {
            "description": "Bucket health returned successfully",
            "schema": {
              "$ref": "#/definitions/BucketHealthResponse"
            }
          }
        }
      }
